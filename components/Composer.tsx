...
export default function Composer({ onSubmit, initial = "", placeholder = "Ask ELIAS anything..." }: {
  ...
  return <div className="composer">
    ...
    <div className="composer-actions">
      <button className="round-action" onClick={() => inputRef.current?.click()}><Plus size={21}/></button>
      ...
      <button className="send-btn" onClick={() => { const v = value.trim(); if (v) { onSubmit(v); setValue(""); } }}><Send size={18}/></button>
    </div>
  </div>
}