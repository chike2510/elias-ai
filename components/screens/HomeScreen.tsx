...
const actions = [
  { href: "/tasks?prompt=Inspect%20this%20project%20and%20propose%20the%20highest-value%20engineering%20improvements", label: "Review a project", icon: Code2 },
  { href: "/tasks?prompt=Research%20this%20question%20using%20current%20primary%20sources%20and%20cite%20the%20evidence", label: "Research", icon: Globe2 },
  { href: "/tasks?prompt=Create%20a%20technical%20architecture%20document", label: "Create a file", icon: FileText },
];

const workspace = [
  { href: "/chat", label: "Chat", detail: "Ask Elias", icon: MessageSquare },
  { href: "/tasks", label: "Tasks", detail: "Run a plan", icon: ListChecks },
