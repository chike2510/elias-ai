...
export default function TaskWorkspace() {
  ...
  return <AppShell title="Tasks">
    <main className="screen task-workspace-screen">
      <header className="task-workspace-header task-mock-header">
